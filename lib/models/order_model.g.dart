...
class OrderModelAdapter extends TypeAdapter<OrderModel> {
  ...
  OrderModel read(BinaryReader reader) {
    ...
    return OrderModel(
      ...
      desconto: fields[5] as int?,
      frete: fields[6] as int?,
      subTotal: fields[7] as double?,
      valorTotal: fields[8] as double?,
      cliente: fields[9] as ClientModel?,
      enderecoEntrega: fields[10] as AddressModel?,
      itens: (fields[11] as List?)?.cast<ItensModel>(),
      pagamento: (fields[12] as List?)?.cast<PaymentModel>(),
    );
  }
